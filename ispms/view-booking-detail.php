...
<html lang="zxx">
<head>
	<title>View Broadband Request Detail</title>
...
<body>
    ...
    <div class="w3layouts-breadcrumbs text-center">
        <div class="container">
            <span class="agile-breadcrumbs"><a href="index.php">Home</a> <span>View Broadband Request Detail</span></span>
        </div>
    </div>
    <!-- //breadcrumbs -->
        ...
        <div class="container">
            <div class="agileinfo-contact-main-address">
                ...
                <div class="list_agileits_w3layouts">
                    <?php
                  $eid=$_GET['editid'];
$sql="SELECT tbluser.FullName,tbluser.MobileNumber,tbluser.Email,tblbroadbandplan.Plan,tblbroadbandplan.Speed,tblbroadbandplan.FUP,tblbroadbandplan.PostFUP,tblbroadbandplan.Benefits,tblbroadbandplan.Price,tblbookbplan.BookingNumber,tblbookbplan.BookingDate,tblbookbplan.Assign,tblbookbplan.Remark,tblbookbplan.Status from  tblbookbplan join tbluser on tbluser.ID=tblbookbplan.UserID join tblbroadbandplan on tblbroadbandplan.ID=tblbookbplan.PlanID where tblbookbplan.ID=:eid";
