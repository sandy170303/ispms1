...
if(isset($_POST['submit']))
  {
   ...
   $assignee=$_POST['assignee'];
    ...
    $sql="insert into tbldthtracking(ApplicationNumber,Remark,Status) value(:bookid,:remark,:status)";
...
$query->bindParam(':bookid',$bookid,PDO::PARAM_STR); 
    ...
    $query->bindParam(':status',$status,PDO::PARAM_STR); 
       $query->execute();
       if($status=='Completed'):
$sql= "update tblbookdthplan set  Status=:status,Remark=:remark where ID=:eid";
$query=$dbh->prepare($sql);
$query->bindParam(':status',$status,PDO::PARAM_STR);
$query->bindParam(':remark',$remark,PDO::PARAM_STR);
$query->bindParam(':eid',$eid,PDO::PARAM_STR);
else:
$sql= "update tblbookdthplan set Assign=:assignee, Status=:status,Remark=:remark where ID=:eid";
$query=$dbh->prepare($sql);
...
echo "<script>window.location.href ='all-dthrequest.php'</script>";
}
...
<html lang="en">
    <head>
        ...
        <title>View DTH Booking Request</title>
            ...
            <div id="layoutSidenav_content">
                <main>
                                ...
                                <div class="row align-items-center justify-content-between">
                                    <div class="col-auto mt-4">
                                        <h1 class="page-header-title">
                                           ...
                                           View DTH Booking Request
                                        </h1>
                                        <div class="page-header-subtitle">View DTH Booking Request</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="container-xl px-4 mt-n10">
                        <div class="card mb-4">
                            <div class="card-header">View DTH Booking Request</div>
                            <div class="card-body">
                               <?php
                  $eid=$_GET['editid'];
...
$bookid=$_GET['bookid']; 
   if($status!=""){
$ret="select tbldthtracking.Remark,tbldthtracking.Status as astatus,tbldthtracking.UpdationDate from tbldthtracking where tbldthtracking.ApplicationNumber =:bookid";
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">DTH Booking</h5>
