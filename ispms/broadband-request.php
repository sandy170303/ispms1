...
<html lang="zxx">
<head>
	<title>Broadband Request History</title>
...
<body>
    ...
    <div class="w3layouts-breadcrumbs text-center">
        <div class="container">
            <span class="agile-breadcrumbs"><a href="index.php">Home</a> <span>Broadband Request History</span></span>
        </div>
    </div>
    <!-- //breadcrumbs -->
    <div class="w3l-main-contact">
        <div class="container">
            <div class="agileinfo-contact-main-address">
                <h4 class="w3ls-inner-title">Broadband Requests</h4>
...
$sql="SELECT tbluser.FullName,tbluser.ID as uid,tbluser.MobileNumber,tbluser.Email,tblbroadbandplan.Plan,tblbookbplan.BookingNumber,tblbookbplan.Status,tblbookbplan.Assign,tblbookbplan.ID as bpid from  tblbookbplan join tbluser on tbluser.ID=tblbookbplan.UserID join tblbroadbandplan on tblbroadbandplan.ID=tblbookbplan.PlanID where tbluser.ID=:uid";
